 ...
 *
 *      自訂側滑選單 Layout
 *      因為要偵測滑動 此 layout 無法攔截onClick 須設置於內部元件上
 *
 */
public class SwipeMenuLayout extends ViewGroup {
    ...
    private boolean defSwipeEnable = true;

    /**
     * IOS、QQ式交互，默认關閉
     */
    private boolean isIos;
    private boolean defIos = false;
    ...
    private boolean defLeftSwipe = true;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        isSwipeEnable = ta.getBoolean(R.styleable.SwipeMenuLayout_swipeEnable, defSwipeEnable);
        isIos = ta.getBoolean(R.styleable.SwipeMenuLayout_ios, defIos);
        isLeftSwipe = ta.getBoolean(R.styleable.SwipeMenuLayout_leftSwipe, defLeftSwipe);
        ta.recycle();
    }
